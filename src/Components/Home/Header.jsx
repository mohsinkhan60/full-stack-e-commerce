...
export const Header = () => {
  return (
    <div className="relative w-full mt-10 overflow-hidden mx-4 rounded-3xl bg-[#D3EBC0]">
      <img
          ...
          <div className="container mx-auto px-4 py-8 md:py-12 lg:py-16">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="w-full md:w-1/2 mb-8 md:mb-0">
                ...
                <button className="bg-green-500 text-white px-6 py-3 rounded-full font-semibold flex items-center hover:bg-green-600 transition-colors">
